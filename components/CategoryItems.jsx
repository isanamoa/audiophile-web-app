...
const CategoryItems = ({ productSlug, productName, productState, rowDirection, productDescription, productCategory, productImage }) => {
  ...
  return (
    <div className={`w-full h-[724px] mb-3 md:mb-12 lg:h-[540px] flex gap-8 lg:gap-x-20 flex-col ${rowDirection % 2 === 1 && 'lg:flex-row-reverse' || 'lg:flex-row'} justify-start items-start rounded`}>
            
            <div className='!w-full h-[352px] lg:h-[540px] bg-[#F1F1F1] rounded flex justify-center items-center'>
                <div className='!w-[220px] lg:!w-[349.238px] h-[243px] lg:h-[386px] bg-contain bg-no-repeat bg-center' >
                    <Image 
                        width={50} 
                        height={95} 
            ...
            <div className='w-full lg:h-[540px] flex flex-col justify-between items-center lg:justify-center lg:items-start gap-y-5 md:text-left text-center'>
                {
                    productState &&
